...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const styles = {
      ...
      /**
       * Mode toggle. The active state must come LAST in the style spread: a
       * generic button style placed after it silently wins the border, which
       * makes the selection nearly invisible.
       */
      toggle: {
        border: '1px solid var(--dsw-alias-border-l2)',
        background: 'var(--dsw-alias-bg-layer-1)',
