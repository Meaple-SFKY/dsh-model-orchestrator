...
export class Orchestrator {
  ...
  async plan(request) {
    ...
    const units =
      tier === 'direct' ? [] : this.#composeUnits(task, analysis, ranked, tier, undefined, assignments, prices);
  ...
  async run(request) {
    ...
    const units = this.#composeUnits(task, analysis, ranked, tier, request.units, assignments, prices);
  ...
  #composeUnits(task, analysis, ranked, tier, suppliedUnits, assignments, prices) {
    const units = [];
